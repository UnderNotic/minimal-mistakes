...
- fully manual that requires public IP and enabled forwarding of port 5000 on router, you can read about it [here.]({{ site.url }}/exposing-local-server-to-the-public-internet/){:target="_blank"}
